...
public class RestitutionVehicule extends JFrame implements ActionListener{
    ...
    RestitutionVehicule() {
        message = new JLabel("Quel est le type de véhicule que vous voulez restituer ?");
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource()== avion){
            RestitutionAvion avion = new RestitutionAvion();
        }else if (e.getSource()==moto){
            RestitutionMoto moto = new RestitutionMoto();
        }else if (e.getSource()==voiture){
            RestitutionVoiture voit = new RestitutionVoiture();
        }
