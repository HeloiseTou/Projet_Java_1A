...
public class AjoutAvion extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource()== annuler){
            ...
            //nouveau.enregistrerAvion(entreeNbHeureVol.getText(), entreeEtat.getText(), entreeModele.getText(), entreeMarque.getText(), entreePrix.getText(), entreeNbMoteur.getText(), entreeVitesse.getText());
