...
public class RestitutionMoto extends JFrame implements ListSelectionListener {
    ...
    RestitutionMoto() {
        ...
        setTitle("Restitution d'une moto");
        setSize(1200, 250);
    ...
    public void valueChanged(ListSelectionEvent event) {
        Stockage.listeDesMotos.get(container.getSelectedRow()).setEtat(false);
        motoChoisie = Stockage.listeDesMotos.get(container.getSelectedRow());
        AfficherFenetreRestitution restitution = new AfficherFenetreRestitution(motoChoisie, "moto");
