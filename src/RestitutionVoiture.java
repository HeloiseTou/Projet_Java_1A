...
public class RestitutionVoiture extends JFrame implements ListSelectionListener {
    ...
    RestitutionVoiture() {
        ...
        setTitle("Restitution d'une voiture");
        setSize(700, 250);
    ...
    public void valueChanged(ListSelectionEvent event) {
        Stockage.listeDesVoitures.get(container.getSelectedRow()).setEtat(false);
        voitureChoisie = Stockage.listeDesVoitures.get(container.getSelectedRow());
        AfficherFenetreRestitution restitution = new AfficherFenetreRestitution(voitureChoisie, "voiture");
